// =========================================================================
// [최종 마스터 완결본] physics.js - 전체 소스 코드 (그림 증발 및 판정 누락 버그 완벽 해결)
// =========================================================================
...
function animate() {
    ...
    // [정밀 복구] 뒤로 15도 누운 과녁 평면 관통 판정 공식 안정화
...
function animate() {
  ...
  if (currentView === 'side') {
    ...
    // [정밀 보정 파트] 증발했던 과녁 일러스트 비례식의 상하면 픽셀 마진 결합 정상화 완료
