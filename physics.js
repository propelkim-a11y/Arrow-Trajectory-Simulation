// ============================================================================
// [Physics Core - Part 1 Mobile Canvas Fix Version]
// ============================================================================
...
function fireArrow() {
  // 1. UI 입력 폼 데이터 캡처 (모바일 빈 값 및 콤포넌트 미안착 대비 옵셔널 체이닝 방어 코드 탑재)
...
function drawScene() {
  ...
  if (viewMode === 'side') {
    ...
    // 거리 눈금 주입 (0m ~ 160m 구간) - 문법 버그 수정 완료
    const distances =;
    distances.forEach(d => {
    ...
    // 높이 눈금 주입 (0m ~ 40m 구간) - 문법 버그 수정 완료
    const heights =;
