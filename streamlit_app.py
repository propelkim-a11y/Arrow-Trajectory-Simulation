...
with top_col1:
    # figsize를 (1.5, 1.5)로 축소
    fig_wind, ax_wind = plt.subplots(figsize=(1.5, 1.5))
    ...
    # 라벨 폰트 크기 최적화
    ax_wind.set_xlabel("Tail/Head", fontsize=6); ax_wind.set_ylabel("Cross", fontsize=6)
    ax_wind.set_title("Wind Vector", fontsize=8)
    ax_wind.tick_params(labelsize=5)
