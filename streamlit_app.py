...
with st.sidebar:
    ...
    # 항력계수 입력창 추가
    cd0 = st.slider("항력계수 (Drag Coefficient, Cd)", 0.1, 1.5, 0.9, help="값이 클수록 공기 저항을 많이 받아 비거리가 줄어듭니다.")
    cl0 = st.slider("양력계수 (Lift Coefficient, Cl)", 0.0, 0.5, 0.05)
