...
# 그래프 시각화 (세로 크기 축소 버전)
# =========================
# figsize의 세로 값을 18에서 12로 줄여 전체 높이를 낮춤
fig, (ax1, ax2, ax3) = plt.subplots(3, 1, figsize=(10, 12), gridspec_kw={'height_ratios': [1, 1, 1.5]})
...
ax1.set_ylim(-2, 15) # 불필요한 상단 여백 제거
ax1.set_title("Flight Trajectory (Side View)")
ax1.set_xlabel("Distance (m)"); ax1.set_ylabel("Height (m)")
ax1.legend(loc='upper right', fontsize='small'); ax1.grid(True)

# 2. Top View (세로 폭 축소 및 Y축 반전)
...
# 3. Front View (과녁은 정사각형 비율 유지를 위해 세로폭 유지)
